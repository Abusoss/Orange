<link href="/orange/templates/header/style.css" rel="stylesheet" />
<header>

    <nav class="navBar">
        <div class="logo">
            <a href="/projet_info/projet_orange"><img src="/projet_info/projet_orange/src/img/logo.png" alt="Accueil" /></a>
        </div>
        <ul>
                ...
                <a href="/orange/aide-et-contact/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 47 47">
                        <g id="Icon_feather-help-circle" data-name="Icon feather-help-circle" transform="translate(-1.5 -1.5)">
                            ...
                            <path id="Tracé_2" data-name="Tracé 2" d="M13.635,15.671a7.749,7.749,0,0,1,15.059,2.583c0,5.166-7.749,7.749-7.749,7.749" transform="translate(3.848 1.745)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                            <path id="Tracé_3" data-name="Tracé 3" d="M18,25.5h0" transform="translate(7 10.5)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="5" />
                        </g>
                    </svg>
