   ...
   php: {
      exo1: {
         ...
         code: `<iframe class="code"
                src=" https://phpsandbox.io/e/x/m1pag?layout=EditorPreview&defaultPath=%2F&theme=dark&showExplorer=no&openedFiles="
                style="display: block"
                loading="lazy"
      ...
      exo2: {
         ...
         code: `<iframe class="code"
                src="https://phpsandbox.io/e/x/yclql?&layout=EditorPreview&iframeId=ajvpag8l3n&theme=dark&defaultPath=/&showExplorer=yes"
                style="display: block"
                loading="lazy"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                height="100%"
      ...
      exo3: {
         ennoncé: "<p>Description de l'exo 3</p>",
         code: `<iframe class="code"
                src="https://phpsandbox.io/e/x/qgc31?&layout=EditorPreview&iframeId=xds3d4utc&theme=dark&defaultPath=/&showExplorer="
                style="display: block"
                loading="lazy"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                height="100%"
